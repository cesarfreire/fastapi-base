...
async def seed_data():
    """
    Popula o banco de dados com permissões e grupos iniciais.
    """
    print("Iniciando o seed do banco de dados...")
    engine = create_async_engine(Settings().DATABASE_URL)

    # Use uma única sessão para todas as operações
    async with AsyncSession(engine, expire_on_commit=False) as session:
        try:
            ...
            print(f"Ocorreu um erro durante o seed do banco de dados: {e}")
            raise
